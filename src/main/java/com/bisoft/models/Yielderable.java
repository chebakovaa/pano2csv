...
import static com.bisoft.models.Completed.completed;
import static com.bisoft.models.Exceptions.unchecked;
import static com.bisoft.models.FlowControl.youMayProceed;
import static com.bisoft.models.IfAbsent.ifAbsent;
import static com.bisoft.models.Message.message;

public interface Yielderable<T> extends Iterable<T> {

    void execute(YieldDefinition<T> builder) throws SQLException;
    ...
    default ClosableIterator<T> iterator() {
        ...
        Thread collectorThread = new Thread(() -> {
            ...
            } catch (BreakException | SQLException e) {
            }
